let pokemons = [];
        ...
        function EditarModal(index) {
            ...
            Swal.fire({
                title: 'Edit Pokémon',
                html: `
                    <input type="text" id="pokemonName" class="swal2-input" placeholder="Name" value="${pokemon.name}">
                    <input type="text" id="pokemonType" class="swal2-input" placeholder="Type" value="${pokemon.type}">
                `,
